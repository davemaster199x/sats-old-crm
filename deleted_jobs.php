...
$plist = $jc->getJobs($offset,$limit,$sort,$order_by,$job_type,$job_status,$service,$state,$date,$phrase,'','','','','','',1);
$ptotal = mysql_num_rows($jc->getJobs('','',$sort,$order_by,$job_type,$job_status,$service,$state,$date,$phrase,'','','','','','',1));
...
<div id="mainContent">
	...
	<div class="sats-breadcrumb">
				...
				<div class="aviw_drop-h aviw_drop-vp" id="view-jobs">
					...
					<div class="fl-left">
						...
						<select name="job_type" style="width: 125px;">
							...
							<?php
							$jt_sql = $jc->getJobs('','','','','','','','','','','j.`job_type`','','','','','',1);
					 ...
					 <?php
					$ajt_sql = $jc->getJobs('','','','','','','','','','','j.`service`','','','','','',1);
				  ?>
					<div class="fl-left">
						<label>Service:</label>
					...
					<div class="fl-left">
						...
						<option value="">Any</option> 			
						<?php
						$jstate_sql = $jc->getJobs('','','','','','','','','','','p.`state`','','','','','',1);
		...
		<table border=0 cellspacing=0 cellpadding=5 width=100% class="tbl-sd vjobs-n" style="margin-top: 0px; margin-bottom: 13px;">			
		...
		<div style="margin-top: 15px; float: right; display:none;" id="no_tenants_div">
			<a href="javascript:void(0);" class="bluebutton btn_no_tenants">No Tenant Details</a>
		</div>
