  ...
  <div class="sats-middle-cont">
    ...
    <div class="sats-breadcrumb">
      <ul>
		...
		<li class="other first"><a title="View Target Agencies" href="/view_target_agencies.php">View Target Agencies</a></li>
        <li class="other first"><a title="View Target Agency Details" href="/view_target_details.php?id=<?php echo $_REQUEST['id']; ?>"><strong>View Target Agency Details</strong></a></li>
      </ul>
    </div>
...
<form action='view_target_details.php?id=<?php echo $_REQUEST['id']; ?>' method=post name='example' id='example'>
...
<table width="100%" cellspacing="1" cellpadding="5" border="0" class="all-table">
			<form method="POST" action="<?=URL;?>view_target_details.php?id=<?php echo $_REQUEST['id']; ?>" class="searchstyle">
...
<form action="<?php echo "/view_target_details.php?id={$_REQUEST['id']}" ?>#uploads" enctype="multipart/form-data" method="post">
