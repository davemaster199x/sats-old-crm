...
.email_variables_btn{
	...
	<div class="addproperty">
		<form method="POST" id="template_form" action="create_email_template_script.php">
			<div class="row">
				<label class="addlabel">Template Name</label>
				<input type="text" class="addinput template_name" name="template_name" id="template_name" />
			</div>
			
			<div class="row">
				<label class="addlabel">Subject</label>
				<input type="text" class="addinput subject" name="subject" id="subject" />
			</div>
			...
			<div class="row">
				...
				<textarea name="et_body" id="et_body" class="addtextarea et_body"></textarea>
			</div>
