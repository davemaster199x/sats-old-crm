...
<div id="mainContent">
    ...
    <div class="sats-middle-cont">
		...
		<form method="post" name='example' id='example' action='/ageing_jobs.php' style="margin:0;">
					...
					<div class="fl-left">
						...
						<style>
							...
							<div class="region_dp_header">
								...
								$params2 = array('is_ageing'=>1);
								$jcount_txt = "(".$jc->getMainRegionCount($_SESSION['country_default'],$main_region_postcodes,'','To Be Booked',$params2).")";
								?>
									<li>
		...
		<table border=0 cellspacing=0 cellpadding=5 width=100% class="tbl-sd" style="margin-top: 0px; margin-bottom: 13px;">			
			<tr class="toprow jalign_left">
				...
				<th>
					<div class="tbl-tp-name colorwhite bold">Outside of Tech Hours</div>
					<?php 
				...
				?>
						<tr class="body_tr jalign_left" style="background-color:<?php echo ($i%2!=0)?'#eeeeee':'' ?>">
							...
							<td>
								...
								if(mysql_num_rows($crm_sql)){
									$crm = mysql_fetch_array($crm_sql);
									$lc = ($crm['eventdate']!="0000-00-00 00:00:00")?date("d/m/Y",strtotime($crm['eventdate'])):''; 
								}else{
									$lc = "";
								}
								echo $lc;
