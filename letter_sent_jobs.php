...
<?php
	...
	if(mysql_num_rows($dstnct_agency_sql)>0){	
		while($dstnct_agency = mysql_fetch_array($dstnct_agency_sql)){
			...
			*/
			...
			// subject
			$subject = "Tenant Notification {$dstnct_agency['address_1']} {$dstnct_agency['address_2']} {$dstnct_agency['address_3']}";
			...
			<p>The Tenants at {$prop_address} have now be notified that SATS will be contacting them to book an appointment to service their property.</p>
	...
	*/
	...
	echo '<div  class="success">All jobs changed to <a href="/to_be_booked_jobs.php">To Be Booked</a></div>';
