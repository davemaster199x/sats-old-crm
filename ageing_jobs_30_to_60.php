...
<div id="mainContent">
    ...
    <div class="sats-middle-cont">
		  ...
		  include('inc/tech_breadcrumb.php');
			...
			<div class="sats-breadcrumb">
			  <ul>
				...
				<li class="other first"><a title="<?php echo $title; ?>" href="/ageing_jobs_30_to_60.php"><strong><?php echo $title; ?></strong></a></li>
			  </ul>
			</div>
		...
		<form method="post" name='example' id='example' action='/ageing_jobs_30_to_60.php' style="margin:0;">
