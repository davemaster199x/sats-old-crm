...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("button#add_ss_mech").live('click', function() {
            ...
            var ss_mech_ts_trip_rate = $("input#ss_mech_ts_trip_rate").val().trim();
            ...
            if(ss_mech_ts_trip_rate == "" || ss_mech_ts_trip_rate === undefined)
            {
                error = 1;
                error_message += "\n" + "Please enter the Trip Rate";
            }
            ...
            else
            {
                ...
                $.ajax({
                    ...
                    data: "job_id=" + job_id + 
                            ...
                            "&alarm_job_type_id=4" + 
                            "&ss_mech_ts_trip_rate=" + ss_mech_ts_trip_rate +
                            "&ss_type=" + ss_type,
                    ...
                    success: function(data){
                        ...
                        if(data.status == "success")
                        {
                            ...
                            applianceAppend += "        </select>";
                            applianceAppend += "    </td>";
                            applianceAppend += "    <td><input type='text' class='ts_comment' name='ss_trip_rate[]' value='" + ss_mech_ts_trip_rate + "' /></td>";
...
<table border=0 cellspacing=0 cellpadding=0 width=100% class="tech_table existing_safety_switch">
    <thead>
        ...
        <tr>
            ...
            <td class="techsheet_header">Trip Rate</td>
        ...
        <tr class="<?php echo  ($x % 2 == 0 ? "off" : "grey"); ?>">
            ...
            <td><input type="text" class="ts_comments" name="ss_trip_rate[]" value="<?php echo $_POST['ss_trip_rate'][$x] ? $_POST['ss_trip_rate'][$x] : $safety_switches[$x]['ts_trip_rate'];?>" /></td>
            <td><input type="text" class="ts_comments_long" name="ss_comments[]" value="<?php echo $_POST['ss_comments'][$x] ? $_POST['ss_comments'][$x] : $safety_switches[$x]['ts_comments'];?>" /></td>
        ...
        <tr>
            ...
            <table cellpadding=2 cellspacing=0 width=100% border=0 id='appliance_table'>
                ...
                <tr bgcolor=#F0F0F0>
                    ...
                    <td><input type=text id='ss_mech_ts_trip_rate' name='ss_mech_ts_trip_rate' value='' class='ts_comments'></td>
